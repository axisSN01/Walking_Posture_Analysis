...
# pygame o que hace es, en el evento de video dibuja esqueleto si esta habilitado, yademas tiene un evento solo para skeleto(pero sin LOCK)
import array
import threading
import ctypes
import cv
...
#---------------------------------------------------------------     
        def save_skeleton(frameSk):
            ...
            is_sk=True                 
#---------------------------------------------------------------
        def draw_skeleton_data(pSkelton, index, positions, thickness = 10):

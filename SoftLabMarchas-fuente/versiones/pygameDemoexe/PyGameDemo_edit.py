...
import thread # modulo multi tarea o hilos de ejecucion.
import itertools # modulo de iteraciones 
import ctypes   # modulo para uso de librerias forasteras de python, ej: dll`s.

import pykinect
from pykinect import nui  # natural user interface
from pykinect.nui import JointId   # union de huesos, cada union es una vectorX4, con x,y,z y w=1
